...
destruct HH1.
assert(HH2 : incl (P :: Q :: nil) (P :: Q :: R :: S :: nil));[my_inO|].
...
assert(HH4 : incl (P :: Q :: R :: nil) (P :: Q :: R :: S :: nil));[my_inO|].
...
assert(HH3 : incl (P :: Q :: R :: T :: nil) (P :: Q :: R :: S :: T :: nil));[my_inO|].
assert(HH4 := matroid2 (P :: Q :: R :: T :: nil) (P :: Q :: R :: S :: T :: nil) HH3).
omega.
assert(HH0 := rk_quintuple_max_3 P Q R S T).
assert(HH1 : incl (P :: Q :: R :: S :: nil) (P :: Q :: R :: S :: T :: nil));[my_inO|].
...
assert(HH := couple_rk1 P P H1);intuition.
...
assert(HH := couple_rk1 Q Q H2);intuition.
assert(HH := couple_rk1 R R H2);intuition.
assert(HH := couple_rk1 Q Q H1);intuition.
Qed.
...
Proof.
intros P Q R R' H0; intuition.
assert(HH := couple_rk1 P P H0);intuition.
assert(HH := couple_rk1 R R H2);intuition.
assert(HH := couple_rk1 R R H2);intuition.
Qed.
