...
intros.
unfold Incid.
elim l;elim A;unfold Incid_bool;solve [auto | right;discriminate].
Qed.
...
Ltac tac l m := abstract (induction l;solve [ discriminate | induction m; solve [discriminate | reflexivity]]).
...
Proof.
intros.
induction A; induction B; solve [left; reflexivity | right; reflexivity | left; tac l m | right; tac l m].
Qed.
...
elim l;unfold Incid, Incid_bool;solve [intuition discriminate].
Qed.
