...
Ltac rk_couple_triple_elim :=
  match goal with

| H : rk(?A :: ?B :: nil) = _, H0 : rk(?A :: ?B :: nil) = _ |- _ => rewrite H0 in H;discriminate
| H : rk(?B :: ?A :: nil) = _, H0 : rk(?A :: ?B :: nil) = _ |- _ => rewrite couple_equal in H;rewrite H0 in H;discriminate

| H : rk(?A :: ?B :: ?C :: nil) = _, H0 : rk(?A :: ?B :: ?C :: nil) = _ |-  _ => rewrite H0 in H;discriminate
| H : rk(?A :: ?C :: ?B :: nil) = _, H0 : rk(?A :: ?B :: ?C :: nil) = _ |-  _ => rewrite <-triple_equal_1 in H;rewrite H0 in H;discriminate
| H : rk(?B :: ?A :: ?C :: nil) = _, H0 : rk(?A :: ?B :: ?C :: nil) = _ |-  _ => rewrite <-triple_equal_2 in H;rewrite H0 in H;discriminate
| H : rk(?B :: ?C :: ?A :: nil) = _, H0 : rk(?A :: ?B :: ?C :: nil) = _ |-  _ => rewrite <-triple_equal_3 in H;rewrite H0 in H;discriminate
| H : rk(?C :: ?A :: ?B :: nil) = _, H0 : rk(?A :: ?B :: ?C :: nil) = _ |-  _ => rewrite <-triple_equal_4 in H;rewrite H0 in H;discriminate
| H : rk(?C :: ?B :: ?A :: nil) = _, H0 : rk(?A :: ?B :: ?C :: nil) = _ |-  _ => rewrite <-triple_equal_5 in H;rewrite H0 in H;discriminate
end.
