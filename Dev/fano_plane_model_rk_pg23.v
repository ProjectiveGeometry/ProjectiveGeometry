...
intro.
rewrite H1 in H0.
assert(HH : equivlist (Q :: Q :: nil) (Q :: nil));[my_inA|].
rewrite HH in H0.
...
Proof.
intros.
assert(HH : incl (P :: Q :: R :: nil) (P :: Q :: R :: S :: nil));[my_inA|].
...
match goal with
| H0 : rk(A :: B :: C :: ?D :: nil) = 2 |- _ => let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
| H0 : rk(A :: B :: ?D :: C :: nil) = 2 |- _ => rewrite <-quadruple_equal_1 in H0;let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
| H0 : rk(A :: C :: B :: ?D :: nil) = 2 |- _ => rewrite <-quadruple_equal_2 in H0;let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
| H0 : rk(A :: C :: ?D :: B :: nil) = 2 |- _ => rewrite <-quadruple_equal_3 in H0;let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
| H0 : rk(A :: ?D :: B :: C :: nil) = 2 |- _ => rewrite <-quadruple_equal_4 in H0;let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
| H0 : rk(A :: ?D :: C :: B :: nil) = 2 |- _ => rewrite <-quadruple_equal_5 in H0;let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
| H0 : rk(B :: A :: C :: ?D :: nil) = 2 |- _ => rewrite <-quadruple_equal_6 in H0;let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
| H0 : rk(B :: A :: ?D :: C :: nil) = 2 |- _ => rewrite <-quadruple_equal_7 in H0;let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
| H0 : rk(B :: C :: A :: ?D :: nil) = 2 |- _ => rewrite <-quadruple_equal_8 in H0;let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
| H0 : rk(B :: C :: ?D :: A :: nil) = 2 |- _ => rewrite <-quadruple_equal_9 in H0;let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
| H0 : rk(B :: ?D :: A :: C :: nil) = 2 |- _ => rewrite <-quadruple_equal_10 in H0;let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
| H0 : rk(B :: ?D :: C :: A :: nil) = 2 |- _ => rewrite <-quadruple_equal_11 in H0;let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
| H0 : rk(C :: A :: B :: ?D :: nil) = 2 |- _ => rewrite <-quadruple_equal_12 in H0;let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
| H0 : rk(C :: A :: ?D :: B :: nil) = 2 |- _ => rewrite <-quadruple_equal_13 in H0;let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
| H0 : rk(C :: B :: A :: ?D :: nil) = 2 |- _ => rewrite <-quadruple_equal_14 in H0;let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
| H0 : rk(C :: B :: ?D :: A :: nil) = 2 |- _ => rewrite <-quadruple_equal_15 in H0;let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
| H0 : rk(C :: ?D :: A :: B :: nil) = 2 |- _ => rewrite <-quadruple_equal_16 in H0;let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
| H0 : rk(C :: ?D :: B :: A :: nil) = 2 |- _ => rewrite <-quadruple_equal_17 in H0;let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
| H0 : rk(?D :: A :: B :: C :: nil) = 2 |- _ => rewrite <-quadruple_equal_18 in H0;let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
| H0 : rk(?D :: A :: C :: B :: nil) = 2 |- _ => rewrite <-quadruple_equal_19 in H0;let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
| H0 : rk(?D :: B :: A :: C :: nil) = 2 |- _ => rewrite <-quadruple_equal_20 in H0;let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
| H0 : rk(?D :: B :: C :: A :: nil) = 2 |- _ => rewrite <-quadruple_equal_21 in H0;let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
| H0 : rk(?D :: C :: A :: B :: nil) = 2 |- _ => rewrite <-quadruple_equal_22 in H0;let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
| H0 : rk(?D :: C :: B :: A :: nil) = 2 |- _ => rewrite <-quadruple_equal_23 in H0;let HH := fresh in assert(HH : rk(A :: B :: C :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 A B C D);try rk_couple_bis_bis;assumption);assumption
end.
...
match goal with
| H0 : rk(P :: Q :: ?R :: ?X :: nil) = 2 |- _ => let HH := fresh in assert(HH : rk(P :: Q :: R :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 P Q R X);try rk_couple_bis_bis;assumption);solve_ex_1 R
| H0 : rk(P :: ?R :: Q :: ?X :: nil) = 2 |- _ => rewrite <-quadruple_equal_2 in H0;let HH := fresh in assert(HH : rk(P :: Q :: R :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 P Q R X);try rk_couple_bis_bis;assumption);solve_ex_1 R
| H0 : rk(P :: ?R :: ?X :: Q :: nil) = 2 |- _ => rewrite <-quadruple_equal_3 in H0;let HH := fresh in assert(HH : rk(P :: Q :: R :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 P Q R X);try rk_couple_bis_bis;assumption);solve_ex_1 R
| H0 : rk(Q :: P :: ?R :: ?X :: nil) = 2 |- _ => rewrite <-quadruple_equal_6 in H0;let HH := fresh in assert(HH : rk(P :: Q :: R :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 P Q R X);try rk_couple_bis_bis;assumption);solve_ex_1 R
| H0 : rk(Q :: ?R :: P :: ?X :: nil) = 2 |- _ => rewrite <-quadruple_equal_8 in H0;let HH := fresh in assert(HH : rk(P :: Q :: R :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 P Q R X);try rk_couple_bis_bis;assumption);solve_ex_1 R
| H0 : rk(Q :: ?R :: ?X :: P :: nil) = 2 |- _ => rewrite <-quadruple_equal_9 in H0;let HH := fresh in assert(HH : rk(P :: Q :: R :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 P Q R X);try rk_couple_bis_bis;assumption);solve_ex_1 R
| H0 : rk(?R :: P :: Q :: ?X :: nil) = 2 |- _ => rewrite <-quadruple_equal_12 in H0;let HH := fresh in assert(HH : rk(P :: Q :: R :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 P Q R X);try rk_couple_bis_bis;assumption);solve_ex_1 R
| H0 : rk(?R :: P :: ?X :: Q :: nil) = 2 |- _ => rewrite <-quadruple_equal_13 in H0;let HH := fresh in assert(HH : rk(P :: Q :: R :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 P Q R X);try rk_couple_bis_bis;assumption);solve_ex_1 R
| H0 : rk(?R :: Q :: P :: ?X :: nil) = 2 |- _ => rewrite <-quadruple_equal_14 in H0;let HH := fresh in assert(HH : rk(P :: Q :: R :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 P Q R X);try rk_couple_bis_bis;assumption);solve_ex_1 R
| H0 : rk(?R :: Q :: ?X :: P :: nil) = 2 |- _ => rewrite <-quadruple_equal_15 in H0;let HH := fresh in assert(HH : rk(P :: Q :: R :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 P Q R X);try rk_couple_bis_bis;assumption);solve_ex_1 R
| H0 : rk(?R :: ?X :: P :: Q :: nil) = 2 |- _ => rewrite <-quadruple_equal_16 in H0;let HH := fresh in assert(HH : rk(P :: Q :: R :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 P Q R X);try rk_couple_bis_bis;assumption);solve_ex_1 R
| H0 : rk(?R :: ?X :: Q :: P :: nil) = 2 |- _ => rewrite <-quadruple_equal_17 in H0;let HH := fresh in assert(HH : rk(P :: Q :: R :: nil) = 2) by (apply (quadruple_rk2_to_triple_rk2 P Q R X);try rk_couple_bis_bis;assumption);solve_ex_1 R
end.
...
| H : _ |- exists J, rk (_ :: _ :: _ :: nil) = 2 /\ rk (_ :: X' :: _ :: nil) = 2 => try solve_ex_2 X'
| H : _ |- exists J, rk (_ :: _ :: _ :: nil) = 2 /\ rk (X' :: _ :: _ :: nil) = 2 => try solve_ex_2 X'
| H : _ |- exists J, rk (_ :: _ :: _ :: nil) = 2 /\ rk (_ :: _ :: _ :: nil) = 2 => try solve_ex_2 X;try solve_ex_2 X'
end.
...
match goal with
| H : rk(P :: Q :: ?X :: ?X' :: nil) = 2 |- _ => rk_inter_simplify_bis P Q R S X X'
| H : rk(P :: ?X :: Q :: ?X' :: nil) = 2 |- _ => rk_inter_simplify_bis P Q R S X X'
| H : rk(P :: ?X :: ?X' :: Q :: nil) = 2 |- _ => rk_inter_simplify_bis P Q R S X X'
| H : rk(Q :: P :: ?X :: ?X' :: nil) = 2 |- _ => rk_inter_simplify_bis P Q R S X X'
| H : rk(Q :: ?X :: P :: ?X' :: nil) = 2 |- _ => rk_inter_simplify_bis P Q R S X X'
| H : rk(Q :: ?X :: ?X' :: P :: nil) = 2 |- _ => rk_inter_simplify_bis P Q R S X X'
| H : rk(?X :: P :: Q :: ?X' :: nil) = 2 |- _ => rk_inter_simplify_bis P Q R S X X'
| H : rk(?X :: P :: ?X' :: Q :: nil) = 2 |- _ => rk_inter_simplify_bis P Q R S X X'
| H : rk(?X :: Q :: P :: ?X' :: nil) = 2 |- _ => rk_inter_simplify_bis P Q R S X X'
| H : rk(?X :: Q :: ?X' :: P :: nil) = 2 |- _ => rk_inter_simplify_bis P Q R S X X'
| H : rk(?X :: ?X' :: P :: Q :: nil) = 2 |- _ => rk_inter_simplify_bis P Q R S X X'
| H : rk(?X :: ?X' :: Q :: P :: nil) = 2 |- _ => rk_inter_simplify_bis P Q R S X X'
end.
