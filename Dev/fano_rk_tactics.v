...
Require Export ProjectiveGeometry.Dev.basic_rank_list.
...
Proof.
intros.
assert(HH : equivlist (P :: P :: R :: nil) (P :: R :: nil));[my_inA|];rewrite HH;apply rk_couple;intuition.
Qed.

Lemma triple_rk2_2 : forall P R, P <> R -> rk(P :: R :: P :: nil) = 2.
Proof.
intros.
assert(HH : equivlist (P :: R :: P :: nil) (P :: R :: nil));[my_inA|];rewrite HH;apply rk_couple;intuition.
Qed.

Lemma triple_rk2_3 : forall P R, P <> R -> rk(R :: P :: P :: nil) = 2.
Proof.
intros.
assert(HH : equivlist (R :: P :: P :: nil) (P :: R :: nil));[my_inA|];rewrite HH;apply rk_couple;intuition.
Qed.

Lemma col_degen_1 : forall P R, rk(P :: P :: R :: nil) = 3 -> False.
Proof.
intros.
assert(HH : equivlist (P :: R :: nil) (P :: P :: R :: nil));[my_inA|].
rewrite <-HH in H.
...
Proof.
intros.
assert(HH : equivlist (P :: R :: nil) (P :: R :: P :: nil));[my_inA|].
rewrite <-HH in H.
assert(HH0 := rk_couple_2 P R).
omega.
Qed.
...
Proof.
intros.
assert(HH : equivlist (P :: R :: nil) (R :: P :: P :: nil));[my_inA|].
rewrite <-HH in H.
assert(HH0 := rk_couple_2 P R).
omega.
Qed.
