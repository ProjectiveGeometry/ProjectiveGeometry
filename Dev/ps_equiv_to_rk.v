...
Lemma rk_upper_dim : forall a b c d, rkl(a :: b :: c :: d :: nil) <= 4.
Proof.
intros.
unfold rkl.
case (contains_four_non_coplanar_points (a :: b :: c :: d :: nil)).
intuition.
case (contains_three_non_collinear_points (a :: b :: c :: d :: nil)).
intuition.
case(contains_two_distinct_points (a :: b :: c :: d :: nil)).
intuition.
intuition.
Qed.
